    ...
    <AppSidebarLayout>
        ...
        <template #sidebar-content>
            <button
                ...
                class="px-3 py-1 mb-4 text-white bg-blue-500 rounded hover:bg-blue-600 w-full"
            >
            ...
            <p v-else class="text-gray-400 italic">Aucune conversation</p>
        </template>

        <!-- CONTENU -->
        <main class="p-4 flex flex-1 flex-col">
            <p v-if="!activeConversation" class="text-gray-400 italic">
