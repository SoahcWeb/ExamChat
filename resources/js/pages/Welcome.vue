...
<template>
    ...
    <div
        class="p-6 lg:justify-center lg:p-8 flex min-h-screen flex-col items-center bg-[#FDFDFC] text-[#1b1b18] dark:bg-[#0a0a0a]"
    >
        <header
            class="mb-6 text-sm lg:max-w-4xl w-full max-w-[335px] not-has-[nav]:hidden"
        >
            <nav class="gap-4 flex items-center justify-end">
                <Link
                    v-if="$page.props.auth.user"
                    :href="dashboard()"
                    class="rounded-sm px-5 py-1.5 text-sm leading-normal inline-block border border-[#19140035] text-[#1b1b18] hover:border-[#1915014a] dark:border-[#3E3E3A] dark:text-[#EDEDEC] dark:hover:border-[#62605b]"
                >
                    Dashboard
                </Link>
                <template v-else>
                    <Link
                        :href="login()"
                        class="rounded-sm px-5 py-1.5 text-sm leading-normal inline-block border border-transparent text-[#1b1b18] hover:border-[#19140035] dark:text-[#EDEDEC] dark:hover:border-[#3E3E3A]"
                    >
                        Log in
                    </Link>
                    <Link
        ...
        <div
            class="lg:grow flex w-full items-center justify-center opacity-100 transition-opacity duration-750 starting:opacity-0"
        >
            <main
                class="rounded-lg lg:max-w-4xl lg:flex-row flex w-full max-w-[335px] flex-col-reverse overflow-hidden"
            >
                <div
                    class="rounded-br-lg rounded-bl-lg bg-white p-6 pb-12 lg:rounded-tl-lg lg:rounded-br-none lg:p-20 flex-1 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]"
                >
                    ...
                    <ul class="mb-4 lg:mb-6 flex flex-col">
                        <li
                            class="gap-4 py-2 before:bottom-0 relative flex items-center before:absolute before:top-1/2 before:left-[0.4rem] before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A]"
                        >
                            <span
                                class="bg-white py-1 relative dark:bg-[#161615]"
                            >
                                <span
                                    class="h-3.5 w-3.5 flex items-center justify-center rounded-full border border-[#e3e3e0] bg-[#FDFDFC] shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)] dark:border-[#3E3E3A] dark:bg-[#161615]"
                                >
                                    <span
                            ...
                            <span>
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    class="ml-1 space-x-1 font-medium inline-flex items-center text-[#f53003] underline underline-offset-4 dark:text-[#FF4433]"
                                >
                        ...
                        <li
                            class="gap-4 py-2 before:top-0 relative flex items-center before:absolute before:bottom-1/2 before:left-[0.4rem] before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A]"
                        >
                            <span
                                class="bg-white py-1 relative dark:bg-[#161615]"
                            >
                    ...
                    <ul class="gap-3 text-sm leading-normal flex">
                        <li>
                            <a
                                href="https://cloud.laravel.com"
                                target="_blank"
                                class="rounded-sm border-black px-5 py-1.5 text-sm leading-normal text-white hover:border-black hover:bg-black dark:hover:border-white dark:hover:bg-white inline-block border bg-[#1b1b18] dark:border-[#eeeeec] dark:bg-[#eeeeec] dark:text-[#1C1C1A]"
                            >
                                Deploy now
                            </a>
                        </li>
                ...
                <div
                    class="rounded-t-lg lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[438px] lg:rounded-t-none lg:rounded-r-lg relative -mb-px aspect-335/376 w-full shrink-0 overflow-hidden bg-[#fff2f2] dark:bg-[#1D0002]"
                >
                    <svg
                        class="translate-y-0 starting:translate-y-6 w-full max-w-none text-[#F53003] opacity-100 transition-all duration-750 dark:text-[#F61500] starting:opacity-0"
                        viewBox="0 0 438 104"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                    >
                    ...
                    <svg
                        class="-ml-8 lg:-mt-[6.6rem] lg:ml-0 relative -mt-[4.9rem] w-[448px] max-w-none dark:hidden"
                        viewBox="0 0 440 376"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                    >
                        <g
                            class="translate-y-0 starting:translate-y-4 opacity-100 transition-all delay-300 duration-750 starting:opacity-0"
                        >
                            <path
                    ...
                    <svg
                        class="-ml-8 lg:-mt-[6.6rem] lg:ml-0 relative -mt-[4.9rem] hidden w-[448px] max-w-none dark:block"
                        viewBox="0 0 440 376"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                    >
                    ...
                    <div
                        class="inset-0 rounded-t-lg lg:overflow-hidden lg:rounded-t-none lg:rounded-r-lg absolute shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]"
                    />
                </div>
            </main>
        </div>
        <div class="h-14.5 lg:block hidden"></div>
    </div>
</template>
